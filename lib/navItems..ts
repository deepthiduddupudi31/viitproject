  ...
  },
{
  ...
  children: [
    ...
    { label: "Research Cell", path: "/cells/research-cell" },
    { label: "Skill Development Lab", path: "/cells/skill-development-cell" },
    { label: "Student Activity Council", path: "/cells/student-activity-council" },
    { label: "WEP Cell", path: "/cells/women-emp-cell" },
    { label: "Assign Cell", path: "/cells/assign-cell" }, 
  ],
},

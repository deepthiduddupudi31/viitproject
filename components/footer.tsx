...
export default function Footer() {
  return (
    <footer className="w-full text-black">
      ...
      <div className="bg-white-100 w-full">
        <div className="max-w-7xl mx-auto px-4 py-12 grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-black/90">
              {[
                ...
                <li key={href}>
                  <Link href={href} className="hover:underline hover:text-blue-800 transition">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <Link href="/directions" className="text-sm text-blue-800 hover:underline flex items-center mt-2">
              How to Reach ↗
            </Link>
      ...
      <div className="bg-blue-800 w-full text-white text-sm">

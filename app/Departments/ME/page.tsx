            ...
            <div className="space-y-6">
              ...
              <section className="bg-white p-8 rounded-lg shadow-sm">
                ...
                <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
                  <p>Established in 2002, the Department of Mechanical Engineering  at Vignan’s Institute of Information Technology is a hub of academic and research excellence. We offer comprehensive B.Tech and M.Tech programs designed to provide a deep understanding of all facets of computer science.</p>
                </div>
              </section>
                ...
                <section className="bg-white p-8 rounded-lg shadow-sm lg:col-span-2">
                  <div className="flex flex-col items-start gap-6">
                    <div className="w-full text-center">
                      <img src="https://vignaniit.edu.in/images/mech_hod_new.jpeg" alt="Mechanical Engineering " className="w-32 h-32 mx-auto object-cover border-4 border-slate-200 rounded-xl" />

      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="bg-white p-4 lg:p-10 rounded-xl shadow-sm mb-6 lg:mb-8">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-800 tracking-tight">
            Department of
            <br />
            <AnimatedBranchName text="Electronics and computer Engineering" />
          </h1>
                ...
                <section className="bg-white p-6 rounded-lg shadow-sm lg:col-span-2">
                  <div className="flex flex-col items-start gap-6">
                    <div className="w-full text-center">
                      <img src="https://vignaniit.edu.in/images/ecm1_hod.jpeg" alt="Dr.H.Devanna" className="w-52 h-52 mx-auto object-cover border-4 border-slate-200 rounded-xl" />
                      <h3 className="mt-4 text-lg font-bold text-slate-900">Dr.H.Devanna</h3>
                      <p className="text-indigo-600 font-semibold text-sm">Head of Department, ECM</p>
                    </div>
                    <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
                      <h2 className="text-2xl font-bold text-slate-800 !mb-2 text-center md:text-left">Message from the HoD</h2>
                      <p>"A warm welcome to ECM@VIIT. Our department is built on a foundation of academic rigor and creative research. We are dedicated to nurturing the next generation of innovators who will shape our digital future by focusing on key areas of study."</p>
                    </div>
                  </div>
                </section>

                ...
                <section className="bg-white p-6 rounded-lg shadow-sm lg:col-span-2">
                  <div className="flex flex-col items-start gap-6">
                    <div className="w-full text-center">
                      <img src="https://vignaniit.edu.in/images/hod_ecm.jpg" alt="Dr. R.Uma Maheswari" className="w-52 h-52 mx-auto object-cover border-4 border-slate-200 rounded-xl" />

                ...
                <section className="bg-white p-8 rounded-lg shadow-sm lg:col-span-2">
                  <div className="flex flex-col items-start gap-6">
                    <div className="w-full text-center">
                      <img src="https://vignaniit.edu.in/images/civil_hod2.jpeg" alt="Dr. K. Mohan Rao" className="w-32 h-32 mx-auto object-cover border-4 border-slate-200 rounded-xl" />

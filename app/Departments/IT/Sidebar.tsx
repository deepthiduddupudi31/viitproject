...
const sidebarItems = [
  ...
  { title: 'About Us', href: '/Departments/IT', icon: Info },
  { title: 'Vision & Mission', href: '/Departments/IT/visionmission', icon: Book },
  { type: 'header', title: 'Academics' },
  { title: 'Programs Offered', href: '/Departments/IT/programs', icon: GraduationCap },
  {
    title: 'Curriculum', icon: Book,
    children: [
      { title: 'POs - B.Tech', href: '/Departments/IT/peos/Btech' },
      { title: 'PEOs - B.Tech', href: '/Departments/IT/peos/Mtech' },
      { title: 'PSOs - B.Tech', href: '/Departments/IT/peos/Mtech' },
    ],
  },
  { type: 'header', title: 'People & Places' },
  { title: 'Faculty', href: '/Departments/IT/faculty', icon: Users },
  { title: 'Infrastructure', href: '/Departments/IT/infrastructure', icon: Building },
  { title: 'Laboratories', href: '/Departments/IT/laboratories', icon: FlaskConical },
  { type: 'header', title: 'Engagement' },
  { title: 'Collaborations', href: '/Departments/IT/CDMD', icon: Handshake },
  { title: 'Achievements', href: '/Departments/IT/extraCirricularActivities', icon: Star },
];

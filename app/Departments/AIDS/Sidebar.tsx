...
const sidebarItems = [
  ...
  { title: 'About Us', href: '/Departments/AIDS', icon: Info },
  { title: 'Vision & Mission', href: '/Departments/AIDS/visionmission', icon: Book },
  { type: 'header', title: 'Academics' },
  { title: 'Programs Offered', href: '/Departments/AIDS/programs', icon: GraduationCap },
  {
    title: 'Curriculum', icon: Book,
    children: [
      { title: 'POs - B.Tech', href: '/Departments/AIDS/peos/Btech' },
      { title: 'PEOs - B.Tech', href: '/Departments/AIDS/peos/Mtech' },
      { title: 'PSOs - B.Tech', href: '/Departments/AIDS/peos/Mtech' },
    ],
  },
  { type: 'header', title: 'People & Places' },
  { title: 'Faculty', href: '/Departments/AIDS/faculty', icon: Users },
  { title: 'Infrastructure', href: '/Departments/AIDS/infrastructure', icon: Building },
  { title: 'Laboratories', href: '/Departments/AIDS/laboratories', icon: FlaskConical },
  { type: 'header', title: 'Engagement' },
  { title: 'Collaborations', href: '/Departments/AIDS/CDMD', icon: Handshake },
  { title: 'Achievements', href: '/Departments/AIDS/extraCirricularActivities', icon: Star },
];

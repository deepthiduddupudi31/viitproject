  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-8 py-16">
        <h1 className="text-4xl font-bold text-red-800 mb-8">Admissions</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-lg shadow">
                <h3 className="font-semibold text-red-800">VITEEE</h3>
                <p className="text-sm text-gray-600">VIT Engineering Entrance Examination</p>
              </div>

              <div className="bg-white p-4 rounded-lg shadow">
                <h3 className="font-semibold text-red-800">VITREE</h3>
                <p className="text-sm text-gray-600">VIT Research Entrance Examination</p>
              </div>

              <div className="bg-white p-4 rounded-lg shadow">
                <h3 className="font-semibold text-red-800">VITMEE</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-semibold text-red-800 mb-4">Important Dates</h3>
            <div className="space-y-4">

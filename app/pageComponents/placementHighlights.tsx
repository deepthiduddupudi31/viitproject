            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
              ...
              <div className="lg:col-span-1">
                  ...
                  <div className="w-32 h-32 bg-white rounded-full flex items-center justify-center shadow-lg border-4 border-yellow-400 group-hover:border-yellow-300 transition-colors duration-300">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-blue-900">
                        {inView && <CountUp end={1215} duration={2} separator="," />}<>+</>
                      </div>
                      <div className="text-sm text-blue-700 font-medium">Placed</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 relative z-10 mb-6">
                  {[
                    { value: 48, label: "Super Dream Offers", color: "text-yellow-400" },
                    { value: 85, label: "Marquee Offers", color: "text-blue-300" },
                    { value: 229, label: "Dream Offers", color: "text-yellow-400" },
                    { value: 1556, label: "Overall Offers", color: "text-blue-300" },
                    { value: 1215, label: "Regular Offers", color: "text-yellow-400" },
              ...
              <div className="lg:col-span-1 space-y-4">
                <div className="text-blue text-sm font-medium">Training Process</div>
              {[
  {

            ...
            <div className="space-y-8">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="flex justify-center lg:justify-start space-x-3">
                  <Link href="#" className="w-12 h-12 bg-blue-800 text-white rounded-lg flex items-center justify-center transition-colors duration-300 hover:bg-red-600">
                    <Youtube className="w-6 h-6" />
                  </Link>
                  <Link href="#" className="w-12 h-12 bg-blue-800 text-white rounded-lg flex items-center justify-center transition-colors duration-300 hover:bg-blue-600">
                    <Facebook className="w-6 h-6" />
                  </Link>
                  <Link href="#" className="w-12 h-12 bg-blue-800 text-white rounded-lg flex items-center justify-center transition-colors duration-300 hover:bg-blue-700">
                    <Linkedin className="w-6 h-6" />
                  </Link>
                  <Link href="#" className="w-12 h-12 bg-blue-800 text-white rounded-lg flex items-center justify-center transition-colors duration-300 hover:bg-black">
                    <Twitter className="w-6 h-6" />
                  </Link>
                  <Link href="#" className="w-12 h-12 bg-blue-800 text-white rounded-lg flex items-center justify-center transition-colors duration-300 hover:bg-pink-600">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            <div className="lg:col-span-1">
              <h2 className="text-5xl lg:text-6xl font-bold text-blue-800 mb-8 leading-tight">
                Placement Highlight
              </h2>
                ...
                <div key={index} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105 border border-gray-200">
                  <div className="flex items-center p-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-bold text-gray-800 text-sm mb-1 group-hover:text-blue-800 transition-colors duration-300">
                        {card.title}
                      </h4>
                    ...
                    <div className="w-6 h-6 bg-blue-600 rounded flex items-center justify-center flex-shrink-0 group-hover:bg-blue-800 transition-colors duration-300">

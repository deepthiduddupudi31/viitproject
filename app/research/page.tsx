    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gray-100 py-16">
        <div className="max-w-6xl mx-auto px-8">
          <h1 className="text-5xl font-bold text-blue-800 mb-12">Research and Innovation</h1>
        ...
        <div className="max-w-6xl mx-auto px-8 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex space-x-6">
              <Button
                variant="outline"
                className="flex items-center space-x-2 border-blue-800 text-blue-800 bg-transparent"
              >

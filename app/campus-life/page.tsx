    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen">
        <div className="grid grid-cols-2 h-screen">
          ...
          <div className="bg-blue-800 text-white flex items-center justify-center p-12">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-8 text-center">
          <h2 className="text-4xl font-bold text-blue-800 mb-6">Explore The Vibrant Life At VIIT</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold text-blue-800 mb-4">Cultural Events</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold text-blue-800 mb-4">Student Clubs</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold text-blue-800 mb-4">Innovation Hub</h3>
